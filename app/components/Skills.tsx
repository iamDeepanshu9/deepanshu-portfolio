...
export default function Skills() {
    ...
    const featuredSkills = [
        { id: "s1", name: "Angular", iconName: "FaAngular" },
        { id: "s2", name: "React", iconName: "FaReact" },
        { id: "s3", name: "Next.js", iconName: "SiNextdotjs" },
        { id: "s4", name: "TypeScript", iconName: "SiTypescript" },
        { id: "s5", name: "Node.js", iconName: "FaNodeJs" },
        { id: "s6", name: "Tailwind CSS", iconName: "SiTailwindcss" },
    ];
    ...
    return (
        <section className="py-20 bg-white overflow-hidden">
            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between mt-10">
                {/* Left Side - Static Featured Skills */}
                ...
                {/* Right Side - Mobile Mockup (Dynamic Skills) */}
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-white overflow-hidden flex flex-col">
                            ...
                            <div className="h-16 bg-neutral-100 border-b border-neutral-200 flex items-end pb-2 justify-center">
                                <span className="text-xs font-bold text-neutral-400">All Skills</span>
                            </div>
                            {/* Mock Body */}
                            <div className="flex-1 p-4 bg-neutral-50 overflow-y-auto no-scrollbar">
                                <div className="space-y-6">
                                    {skills.length === 0 ? (
                                        <p className="text-xs text-gray-400 text-center mt-10">No skills added yet.</p>
                                    ) : (
                                        Object.entries(
                                                ...
                                                <div className="space-y-2">
                                                    {categorySkills.map((skill) => (
                                                        <div key={skill.id} className="flex items-center p-2 bg-white rounded-lg shadow-sm border border-neutral-100">
                                                            <div className={`w-1.5 h-1.5 rounded-full mr-2 bg-black`}></div>
